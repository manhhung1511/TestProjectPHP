...
if (isset($_POST["submit"])) {
    ...
    $messagebird = new MessageBird\Client('kJOf78VnKE1ll0ynapUGkqV3D');
    $message = new MessageBird\Objects\Message;
    $message->originator = '+84865817698';
            ...
            <div class="col-md-5 mx-auto bg-white shadow border p-4 rounded">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea rows="5" class="form-control" placeholder="Enter message" required name="message"
                            id="message"></textarea>
                    </div>
                    <div>
